...
# with command line options: step4 --python_filename EWKZ2Jets_ZToQQ_MINIAOD_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --fileout file:EWKZ2Jets_ZToQQ_MINIAOD.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step PAT --geometry DB:Extended --filein file:EWKZ2Jets_ZToQQ_RECO.root --era Run3 --no_exec --mc -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:EWKZ2Jets_ZToQQ_RECO.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EWKZ2Jets_ZToQQ_MINIAOD.root'),
